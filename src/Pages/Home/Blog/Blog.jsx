...
const Blog = () => {
    return (
        <div className="container my-5 py-5">
            <h2 className='text-center fs-2 fw-bold py-2 w-25 mx-auto'>Our Latest Blog</h2>
            <div className="card-group row">
                <div className="card col-md-6">
                    <img  src={img1} className="card-img-top h-50" alt="..."/>
                        <div className="card-body">
                        <h5 className="card-title fw-bold">Eco-Warriors Paradise: Discover the Best Sustainable Products of 2023</h5>
                            <p className="card-text">As we settle into 2023, its time to revamp our living spaces and embrace the latest must-have products that can elevate our homes to the next level. From innovative tech gadgets to stylish home decor, we've curated a list of the top 10 </p>
                        </div>
